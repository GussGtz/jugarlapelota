<template>
  <div class="space-y-4 md:space-y-6">
    ...
    <!-- Score modal -->
    <div v-if="showScore" class="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
    ...
    <!-- Confirm dialog -->
    <div v-if="confirmDialog.show" class="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[60] flex items-center justify-center p-4">
